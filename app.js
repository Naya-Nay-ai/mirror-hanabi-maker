...
const COLOR_MAP = { sakura:{label:'さくらピンク',hex:'#ff8fc8'}, navy:{label:'夜空ブルー',hex:'#4d64ff'}, gold:{label:'はちみつゴールド',hex:'#ffd76a'}, white:{label:'月明りアイボリー',hex:'#ffe0a8'}, mint:{label:'薄荷グリーン',hex:'#8df0c8'}, orange:{label:'夕焼けオレンジ',hex:'#ff9a4d'}, violet:{label:'すみれパープル',hex:'#b989ff'}, red:{label:'いちごレッド',hex:'#ff5572'} };
